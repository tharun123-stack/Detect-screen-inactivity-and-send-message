...
public class Linux extends Applet implements WindowListener
{
    ...
    Linux()
    {
       ...
       fr.setBackground(Color.cyan);
        ...
        lbl1= new Label("You have joined **** Linux class ****");
...
//       fr.add(btnCancel);
    ...
    //                    Class.forName("com.mysql.jdbc.Driver");
      //                  con = DriverManager.getConnection("jdbc:mysql://localhost/library_system", "root", "password");
                       ...
                       PreparedStatement pstmt = con.prepareStatement("insert into work3 values(?, ?)"); 
...
public void windowActivated(WindowEvent ev)
{
    ...
    System.out.println(dfor.format(obj));
    Connection con = signin.initializeDatabase();
    PreparedStatement st = con.prepareStatement("insert into windowevent2  values (?, ?, ?) ");
