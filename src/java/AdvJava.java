...
public class AdvJava extends Applet implements WindowListener
{
    ...
    AdvJava()
    {
       ...
       fr.setBackground(Color.cyan);
        ...
        lbl1= new Label("You have joined **** Advanced Java class ****");
...
//       fr.add(btnCancel);
    ...
    //                    Class.forName("com.mysql.jdbc.Driver");
      //                  con = DriverManager.getConnection("jdbc:mysql://localhost/library_system", "root", "password");
                       ...
                       PreparedStatement pstmt = con.prepareStatement("insert into work1 values(?, ?)"); 
...
public void windowActivated(WindowEvent ev)
{
    ...
    System.out.println(dfor.format(obj));
    Connection con = signin.initializeDatabase();
    PreparedStatement st = con.prepareStatement("insert into windowevent3  values (?, ?, ?) ");
