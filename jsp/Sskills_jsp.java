...
public final class Sskills_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String a1;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Soft skills class</title>\n");
      out.write("                <style>\n");
      out.write(".button1 {\n");
      ...
      out.write("            ");
            ...
            String query2 = "SELECT action,time FROM windowevent5 where status5=0;";
      ...
      out.write("            ");
                ...
                try
                {
                    ...
                    String query1 = "delete from windowevent5";
      ...
      out.write("            \n");
      out.write("            \n");
      out.write("            <h2> <u> The work done by Student:</U></h2>\n");
      out.write("            ");

                

            Statement stm = con.createStatement();
            String query = "SELECT * FROM work5";
  ...
  try
                {
                    ...
                    Statement st = con.createStatement();
                    String query2 = "DELETE FROM work5";
      ...
      out.write("            <form action=\"Sskills.jsp\">\n");
      ...
      out.write("            ");
                ...
                try { 
                    ...
                    String s0 = "Soft_skills";
                    
                    PreparedStatement st = con.prepareStatement("insert into softskills values(?, ? ,?)"); 
                    st.setString(1, a1);
                    st.setString(2, s0);
                    st.setString(3, s1);
                    st.executeUpdate();
