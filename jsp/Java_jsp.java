 ...
 String a1;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Java class</title>\n");
      out.write("                        <style>\n");
      out.write(".button2 {\n");
      ...
      out.write("            \n");
      out.write("            <br/><br/>\n");
      out.write("            <u><b> Log Status: </b></u><br/><br/>\n");
      out.write("            \n");
      out.write("            ");
  ...
  try
                {
                    ...
                    Statement st = con.createStatement();
                    String query2 = "DELETE FROM work1";
      ...
      out.write("            ");
                ...
                try { 
                    ...
                    String s0 = "Advanced_Java";
                    
                    PreparedStatement st = con.prepareStatement("insert into java values(?, ? ,?)"); 
                    st.setString(1, a1);
                    st.setString(2, s0);
                    st.setString(3, s1);
                    st.executeUpdate();
