 ...
 String a1;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Knowledge Engineerng</title>\n");
      out.write("                <style>\n");
      out.write(".button1 {\n");
      ...
      out.write("    <body>\n");
      out.write("    <CENTER>\n");
      out.write("        <H2> KNOWLEDGE ENGINEERING</H2>\n");
      ...
      out.write("            ");
            ...
            String query2 = "SELECT action,time FROM windowevent1 where status1=0;";
      ...
      out.write("            ");
                ...
                try
                {
                    ...
                    String query1 = "delete from windowevent1";
      ...
      out.write("            ");
            ...
            String query = "SELECT * FROM work2";
  ...
  try
                {
                    ...
                    Statement st = con.createStatement();
                    String query2 = "DELETE FROM work2";
      ...
      out.write("            <form action=\"Knowledge.jsp\">\n");
      ...
      out.write("            ");
                ...
                try { 
                    ...
                    String s0 = "Knowledge_Engineering";
                    
                    PreparedStatement st = con.prepareStatement("insert into knowledge values(?, ? ,?)"); 
                    st.setString(1, a1);
                    st.setString(2, s0);
                    st.setString(3, s1);
                    st.executeUpdate();
